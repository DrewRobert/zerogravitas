...
public class RemoveVideoSegmentPlaylistHandlerTest {
    ...
    @Test
    public void testRemoveVideoSegmentPlaylistHandler() {
        RemoveVideoSegmentPlaylistHandler handler = new RemoveVideoSegmentPlaylistHandler(s3Client);
