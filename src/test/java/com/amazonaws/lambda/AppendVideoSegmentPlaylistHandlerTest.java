...
public class AppendVideoSegmentPlaylistHandlerTest {
    ...
    @Test
    public void testAppendVideoSegmentPlaylistHandler() {
        AppendVideoSegmentPlaylistHandler handler = new AppendVideoSegmentPlaylistHandler(s3Client);
